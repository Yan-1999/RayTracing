...
bool RayTracing::XYRect::hit(const Ray& r, ValType t_min, ValType t_max,
	HitRecord& rec) const
{
...
bool RayTracing::XZRect::hit(const Ray& r, ValType t_min, ValType t_max,
    HitRecord& rec) const 
{
...
bool RayTracing::YZRect::hit(const Ray& r, ValType t_min, ValType t_max,
    HitRecord& rec) const 
{
